    ...
    def baseconfig(self):
        ...
        self.new_i2c_devices(
            [
                ...
                ('pca9548', 0x75, 10), # 9548_NIF_1
                ('pca9548', 0x75, 11), # 9548_NIF_2
                ('pca9548', 0x75, 12), # 9548_NIF_3
                ('pca9548', 0x75, 13), # 9548_NIF_4
                ('pca9548', 0x75, 14), # 9548_NIF_5
        ...
        for port in range(33, 73):
            self.new_i2c_device('optoe1', 0x50, port)
        
        # init QSFPDD NIF EEPROM
        for port in range(73, 109):
            self.new_i2c_device('optoe1', 0x50, port)
        
        # init SFP EEPROM
        for port in range(109, 111):
        ...
        for i, addr in enumerate((0x33, 0x34)):
            self.new_i2c_device("s9710_76d_cpld" + str(i+1), addr, 30)    
