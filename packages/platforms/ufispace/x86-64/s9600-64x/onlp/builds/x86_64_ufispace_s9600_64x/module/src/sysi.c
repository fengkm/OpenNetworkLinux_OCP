...
onlp_sysi_platform_get(void)
{
    ...
    if (read_ioport(mb_cpld1_addr, &mb_cpld1_board_type_rev) < 0) {
        ...
        return "x86-64-ufispace-s9600-64x-rx";
    }
    //FIXME: check model id is 3 bits or 2 bits
    mb_cpld1_hw_rev = ((mb_cpld1_board_type_rev) & 0x03);
    mb_cpld1_build_rev = ((mb_cpld1_board_type_rev) >> 3 & 0x07);

    //FIXME: check rx
    if (mb_cpld1_hw_rev == 1 && mb_cpld1_build_rev == 1) {
        return "x86-64-ufispace-s9600-64x-r0";
    } else if (mb_cpld1_hw_rev == 1 && mb_cpld1_build_rev == 2) {
        return "x86-64-ufispace-s9600-64x-r1";
    } else if (mb_cpld1_hw_rev == 1 && mb_cpld1_build_rev == 3) {
        return "x86-64-ufispace-s9600-64x-r2";
    } else if (mb_cpld1_hw_rev == 1 && mb_cpld1_build_rev == 4) {
        return "x86-64-ufispace-s9600-64x-r3";
    } else if (mb_cpld1_hw_rev == 2 && mb_cpld1_build_rev == 1) {
        return "x86-64-ufispace-s9600-64x-r4";
    } else if (mb_cpld1_hw_rev == 2 && mb_cpld1_build_rev == 2) {
        return "x86-64-ufispace-s9600-64x-r5";
    } else if (mb_cpld1_hw_rev == 2 && mb_cpld1_build_rev == 3) {
        return "x86-64-ufispace-s9600-64x-r6";
    } else if (mb_cpld1_hw_rev == 2 && mb_cpld1_build_rev == 4) {
        return "x86-64-ufispace-s9600-64x-r7";
    } else if (mb_cpld1_hw_rev == 3 && mb_cpld1_build_rev == 1) {
        return "x86-64-ufispace-s9600-64x-r8";
    } else if (mb_cpld1_hw_rev == 3 && mb_cpld1_build_rev == 2) {
        return "x86-64-ufispace-s9600-64x-r9";
    } else {
        return "x86-64-ufispace-s9600-64x-r9";
    }
}
