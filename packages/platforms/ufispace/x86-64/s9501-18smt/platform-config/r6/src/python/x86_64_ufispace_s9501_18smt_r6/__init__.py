...
class OnlPlatform_x86_64_ufispace_s9501_18smt_r6(OnlPlatformUfiSpace):
    PLATFORM='x86-64-ufispace-s9501-18smt-r6'
    MODEL="S9501-18SMT"
    SYS_OBJECT_ID=".9501.18"
    PORT_COUNT=18
    PORT_CONFIG="4x1 + 8x2.5 + 6x10"
    ...
    def baseconfig(self):
        ...
        # init QSFP/QSFP+ EEPROM
        for port in range(bus_ismt+9, bus_ismt+23):
